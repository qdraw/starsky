...
- **Apple Silicon macOS Support**: We're thrilled to introduce support for Apple Silicon macOS in
...
- **Native File Opening**: Experience seamless file opening on both Windows and macOS with native
  file open support. (PR #1381)

## Feedback

- Based on user feedback the documentation on "Getting Started" and Tagging is improved. Thanks for
  the feedback. The verbose setting is removed out of the UI since users don't understand it and
  didn't had any value for a normal end user.
