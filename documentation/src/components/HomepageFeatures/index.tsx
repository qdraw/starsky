...
const FeatureListRow1: FeatureItem[] = [
	{
		...
		description: (
			...
			That's why finding what you've been looking for quickly and easily is a great way to get a lot more done in a shorter amount of time.
	...
	},
	{
		...
		description: (
			<>
			All information about a specific photo that you enter into the photo management tool will end up in the photo. 
			That includes labels, description and location information. 
			The tool uses standards, all meta information contained in the image is also written into the image itself. 
	...
	},
	{
		...
		description: (
			<>
			Mobile phones accurately track the location of a photo. However, many cameras don't do this yet. 
			To avoid having to manually add location data to each photo, I use a sports app on my phone. 
			It keeps track of my location. I then export this information from the sports app, after which the photo management application automatically brings it all together.
			 Then I put the gpx file containing all the locations and times in the same folder and run a script that automates this integration. 
			</>
		),
	},
];
...
const FeatureListRow2: FeatureItem[] = [
	{
		...
		description: (
			...
			&nbsp;<Link href="docs/getting-started/raspberry-pi">Read more about running on a Raspberry Pi</Link>
			</>
		),
	},
	{
...

	{
		...
		description: (
			<>
				  ...
				  But how do you get them in the right format? That is often a task that you have to wait until you get home and need a computer with the right software. 
				  Based on these selections I do an automatic publication action. This places a watermark in the images.  &nbsp;
