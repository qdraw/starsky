...
for (var i = 0; i < htmlFullPathList.length; i++) {
	...
	<header class="docs-header">
		<div class="wrapper">
			<div class="detective"></div> <a href="` + relativeCssPath + `readme.html" class="name">Starsky Docs</a>
		</div>
	</header>`;
	...
	contentsHtml = contentsHtml.replace(/<\/html>/ig, `<!-- Generated by Starsky Docs v${package.version} on ${new Date().toLocaleDateString("en-US",{ year: 'numeric', month: 'long', day: 'numeric' })} -->\n </html>`);
