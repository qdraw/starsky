...
import ModalDropAreaFilesAdded from '../../organisms/modal-drop-area-files-added/modal-drop-area-files-added';
...
storiesOf("components/atoms/drop-area", module)
  .add("default", () => {
    ...
    return <><div>Drag 'n drop file to show<br /><br />
    </div>
      <DropArea enableDragAndDrop={true} enableInputButton={true} callback={(add) => {
