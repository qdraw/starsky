...
- [x] (Changed) _Back-end_ Upgrade to .NET 6 - SDK 6.0.414 (Runtime: 6.0.18) (PR #1237)
...
- [x] **(Breaking Change)** _Back-end_ Use Application Insights Connection String instead of Instrumentation Key (PR #920, Issue #908)
...
- [x] **(Breaking Change)** _Back-end_ Use Data Protection Keys in Database instead of on disk (PR #933)
...
- [x] (Fixed) _Back-end_ Fix ImageSharp default behavior for writing base64 strings (PR #665 / Issue #664)
...
- [x] (Fixed) _Back-end_ Import UnitTests **Can't build after 2020-04-22, Import UnitTests have a date bug.**
