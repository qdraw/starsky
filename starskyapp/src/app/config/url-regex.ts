...
export const ipRegex = new RegExp("^https?:\\\/\\\/((25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\.){3}(25[0-5]|2[0-4][0-9]|[01]?" + 
"[0-9][0-9]?):?([0-9]{0,5})?\\\/?([a-z]+)?$","ig")

// unescaped: https://stackoverflow.com/a/9284473
export const urlRegex = new RegExp("^(?:(?:https?|ftp):\\\/\\\/)(?:\\S+(?::\\S*)?@)?(?:(?!(?:10|127)(?:\\.\\d{1,3}){3})(?!(?:169\\.254|192\\.168)(?:\\." + 
