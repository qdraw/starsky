	...
	public static class Win32Processes
	{
		...
		public static List<Process> GetProcessesLockingFile(string path)
		{
			...
			try
			{
				...
				res = RmRegisterResources(handle, ( uint )resources.Length, resources, 0, null, 0,
					null);
		...
		private static List<Process> EnumerateProcesses(uint pnProcInfoNeeded, uint handle,
			uint lpdwRebootReasons)
		{
			...
			// Get the list
			var res = RmGetList(handle, out pnProcInfoNeeded, ref pnProcInfo, processInfo,
				ref lpdwRebootReasons);
