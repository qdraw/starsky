...
namespace starskytest.starsky.foundation.writemeta.JsonService
{
	...
	public sealed class FileIndexItemJsonParserTest
	{
		...
		private FileIndexItem ExampleItem { get; set; } = new FileIndexItem("/test.jpg")
		{
			...
			Title = "Title",
			DateTime = new DateTime(2020, 01, 01, 00,00,00, kind: DateTimeKind.Unspecified),
			AddToDatabase = new DateTime(2020, 01, 01, 00,00,00, kind: DateTimeKind.Local),
			LastEdited = new DateTime(2020, 01, 01, 00,00,00, kind: DateTimeKind.Local),
			Latitude = 50,
			Longitude = 5,
			LocationAltitude = 1,
