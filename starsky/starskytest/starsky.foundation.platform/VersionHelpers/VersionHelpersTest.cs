...
public sealed class VersionHelpersTest
{
	...
	private static readonly IReadOnlyList<SemVersion> VersionsInOrder = new List<SemVersion>
	{
		...
		new(0, 0, 1, ".a"),
		new(0, 0, 1, "b"),
		new(0, 0, 1, "gamma.12.87"),
		new(0, 0, 1, "gamma.12.87.1"),
		new(0, 0, 1, "gamma.12.87.99"),
		new(0, 0, 1, "gamma.12.87.X"),
		new(0, 0, 1, "gamma.12.88"),
		new(0, 0, 1, "", "12"),
		new(0, 0, 1, "", "."),
		new(0, 0, 1, "", ".."),
		new(0, 0, 1, "", ".a"),
		new(0, 0, 1, "", "bu"),
		new(0, 0, 1, "", "build.12"),
		new(0, 0, 1, "", "build.12.2"),
		new(0, 0, 1, "", "build.13"),
		new(0, 0, 1, "", "uiui"),
		new(0, 1, 1),
		new(0, 2, 1),
		new(1, 0, 0, "alpha"),
		new(1, 0, 0, "alpha", "dev.123"),
		new(1, 0, 0, "alpha", "😞"),
		new(1, 0, 0, "alpha.1"),
		new(1, 0, 0, "alpha.beta"),
		new(1, 0, 0, "beta"),
		new(1, 0, 0, "beta", "dev.123"),
		new(1, 0, 0, "beta.2"),
		new(1, 0, 0, "beta.11"),
		new(1, 0, 0, "rc.1"),
		new(1, 0, 0, "😞"),
