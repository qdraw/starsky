...
public sealed class XmpReadHelperTest
{
	private const string Input =
		"<x:xmpmeta xmlns:x=\"adobe:ns:meta/\" x:xmptk=\"XMP Core 5.1.2\"> <rdf:RDF xmlns:rdf=\"" +
		...
		" </rdf:Alt> </dc:title> <Iptc4xmpExt:LocationCreated> <rdf:Bag>" +
		" <rdf:li Iptc4xmpExt:Sublocation=\"\" Iptc4xmpExt:City=\"Epe\" " +
	...
	private const string InputArtistXmpExample =
		"<x:xmpmeta xmlns:x='adobe:ns:meta/' x:xmptk='Image::ExifTool 13.42'>\n" +
		"<rdf:RDF xmlns:rdf='http://www.w3.org/1999/02/22-rdf-syntax-ns#'>\n\n" +
		" <rdf:Description rdf:about=''\n" +
		"  xmlns:dc='http://purl.org/dc/elements/1.1/'>\n" +
		"  <dc:creator>\n   <rdf:Seq>\n   " +
		" <rdf:li>marianne</rdf:li>\n   </rdf:Seq>\n  " +
		"</dc:creator>\n </rdf:Description>\n\n " +
		"<rdf:Description rdf:about=''\n  " +
		"xmlns:tiff='http://ns.adobe.com/tiff/1.0/'>\n " +
		" <tiff:Artist>marianne</tiff:Artist>\n " +
		"</rdf:Description>\n\n </rdf:RDF>\n</x:xmpmeta>\n";
	...
	{
		var data =
			new ReadMetaXmp(new FakeIStorage(), new FakeIWebLogger()).GetDataFromString(Input);
	...
	[TestMethod]
	public void XmpReadHelperTest_GetData_usingArtistStringExample()
	{
		var data =
			new ReadMetaXmp(new FakeIStorage(), new FakeIWebLogger()).GetDataFromString(
				InputArtistXmpExample);
		Assert.AreEqual("marianne", data.Artist);
	}
	...
	public async Task XmpReadHelperTest_XmpGetSidecarFile_WithFakeStorage()
	{
		...
		var data =
			await new ReadMetaXmp(fakeIStorage, new FakeIWebLogger()).XmpGetSidecarFileAsync(
				fileIndexItem);
	...
	public async Task XmpReadHelperTest_XmpGetSidecarFile_TestIfOverwrite()
	{
		...
		var fileIndexItem = new FileIndexItem
		{
			...
			DateTime = new DateTime(1990, 01, 01, 01, 00, 00, DateTimeKind.Local)
		};
