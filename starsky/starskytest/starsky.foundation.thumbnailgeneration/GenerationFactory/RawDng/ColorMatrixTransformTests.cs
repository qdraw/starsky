...
public class ColorMatrixTransformTests
{
	...
	{
		var cameraToSrgb = ColorMatrixTransform.BuildCameraToSrgb(
			new[,] { { 1f, 0f, 0f }, { 0f, 1f, 0f }, { 0f, 0f, 1f } },
			new[,] { { 1f, 0f, 0f }, { 0f, 1f, 0f }, { 0f, 0f, 1f } }, 17);
	...
	public void ApplyInPlace_WithIdentityMatrix_KeepsValues()
	{
		...
		ColorMatrixTransform.ApplyInPlace(rgb,
			new[,] { { 1f, 0f, 0f }, { 0f, 1f, 0f }, { 0f, 0f, 1f } });
	...
	[TestMethod]
	public void ApplyInPlace_DoesNotClampNegativeIntermediateValues()
	{
		var rgb = new float[1, 1, 3];
		rgb[0, 0, 0] = 0.1f;
		rgb[0, 0, 1] = 0.2f;
		...
		ColorMatrixTransform.ApplyInPlace(rgb,
			new[,] { { 1f, 0f, -2f }, { 0f, 1f, 0f }, { 0f, 0f, 1f } });

		Assert.IsLessThan(0f, rgb[0, 0, 0]);
		Assert.AreEqual(0.2f, rgb[0, 0, 1], 1e-6f);
		Assert.AreEqual(0.3f, rgb[0, 0, 2], 1e-6f);
	}
	...
	public void BuildCameraToSrgb_WithUserFixtureColorMatrix_MapsWhiteBalancedNeutralToGray()
	{
		...
		var cameraToSrgb = ColorMatrixTransform.BuildCameraToSrgb(
			new[,]
			{
				{ 0.544808f, -0.174047f, -0.080399f }, { -0.075055f, 0.440444f, 0.011367f },
				{ -0.005801f, 0.071589f, 0.118914f }
			}, new[,] { { 1f, 0f, 0f }, { 0f, 1f, 0f }, { 0f, 0f, 1f } }, 1,
