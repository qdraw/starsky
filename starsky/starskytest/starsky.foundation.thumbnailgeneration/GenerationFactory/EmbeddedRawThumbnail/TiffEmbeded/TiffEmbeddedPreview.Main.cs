...
public class TiffEmbeddedPreviewCoverageTests
{
    ...
    public void TryReadIfdEntryHeader_WithTooShortBlock_ReturnsFalse()
    {
        ...
        // Act
        // blockLength = 5 (< 6)
        var result = TiffEmbeddedPreviewExtractor.TryReadIfdEntryHeader(ms, 8, 5, true, out _, out _);
    ...
    public void TryReadIfdEntryHeader_WithEntryCountReadFailure_ReturnsFalse()
    {
        ...
        // Act
        var result = TiffEmbeddedPreviewExtractor.TryReadIfdEntryHeader(ms, 1, 10, true, out _, out _);
    ...
    public void TryResolveMakerNoteOffset_WithAbsoluteOffsetFound_ReturnsTrue()
    {
        ...
        // Act
        var result = TiffEmbeddedPreviewExtractor.TryResolveMakerNoteOffset(ms, 10, 50, out var resolvedOffset);
    ...
    public void TryReadIfdEntryHeader_WithLargeEntryCount_ReturnsFalse()
    {
        ...
        // Act
        var result = TiffEmbeddedPreviewExtractor.TryReadIfdEntryHeader(ms, 8, 100, true, out _, out _);
    ...
    public void AppendDirectJpegCandidate_WithStripTooSmall_Skips()
    {
        ...
        // Act
        TiffEmbeddedPreviewExtractor.AppendDirectJpegCandidate(previews, state, ms, RawFlavor.Unknown);
    ...
    public void ScanJpegsInRange_WithTooShortRange_ReturnsEmpty()
    {
        ...
        Assert.IsEmpty(new List<TiffEmbeddedPreviewExtractor.PreviewCandidate?>(result));
    }
