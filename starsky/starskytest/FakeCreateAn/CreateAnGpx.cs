...
public class CreateAnGpx
{
	...
	public static readonly string FullFileGpxPath =
	...
	public static readonly ImmutableArray<byte> Bytes =
		[..Base64Helper.TryParse(Base64GpxString)];

	public readonly string BasePath =
		Path.GetDirectoryName(Assembly.GetEntryAssembly()?.Location) +
		Path.DirectorySeparatorChar;

	public CreateAnGpx(bool writeFile = false)
	{
		if ( writeFile && !File.Exists(FullFileGpxPath) )
		{
