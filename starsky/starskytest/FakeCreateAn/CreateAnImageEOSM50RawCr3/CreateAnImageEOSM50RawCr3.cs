...
namespace starskytest.FakeCreateAn.CreateAnImageEOSM50RawCr3;

public class CreateAnImageEOSM50RawCr3
{
	public readonly ImmutableArray<byte> Bytes = [];

	public CreateAnImageEOSM50RawCr3()
	{
		...
		var path = Path.Combine(dirName, "FakeCreateAn",
			"CreateAnImageEOSM50RawCr3", "IMG_0483_Canon EOS M50.CR3");
