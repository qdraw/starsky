...
public class ExecuteWithRetryTest
{
	...
	[TestMethod]
	public void IsTransientDbException_DbUpdateConcurrencyException_ReturnsFalse()
	{
		Assert.IsFalse(ExecuteWithRetry.IsTransientDbException(new DbUpdateConcurrencyException()));
	}
