...
public sealed class QueryTest
{
	...
	public async Task GetAllFilesAsync_Disposed()
	{
		...
		await dbContext.FileIndex.AddAsync(new FileIndexItem("/") { IsDirectory = true }, TestContext.CancellationToken);
		await dbContext.FileIndex.AddAsync(new FileIndexItem("/test.jpg"), TestContext.CancellationToken);
	...
	public async Task GetAllRecursiveAsync_GetResult()
	{
		...
		await dbContext.FileIndex.AddAsync(
			new FileIndexItem("/GetAllRecursiveAsync") { IsDirectory = true }, TestContext.CancellationToken);
		await dbContext.FileIndex.AddAsync(
			new FileIndexItem("/GetAllRecursiveAsync/test") { IsDirectory = true }, TestContext.CancellationToken);
		await dbContext.FileIndex.AddAsync(new FileIndexItem("/GetAllRecursiveAsync/test.jpg"), TestContext.CancellationToken);
		await dbContext.FileIndex.AddAsync(
			new FileIndexItem("/GetAllRecursiveAsync/test/test.jpg"), TestContext.CancellationToken);
		await dbContext.SaveChangesAsync(TestContext.CancellationToken);
	...
	public async Task GetAllRecursiveAsync_Disposed()
	{
		...
		await dbContext.FileIndex.AddAsync(new FileIndexItem("/gar") { IsDirectory = true }, TestContext.CancellationToken);
		await dbContext.FileIndex.AddAsync(new FileIndexItem("/gar/test.jpg"), TestContext.CancellationToken);
		await dbContext.SaveChangesAsync(TestContext.CancellationToken);
	...
	public async Task UpdateItemAsync_Multiple_DisposedItem()
	{
		...
		await dbContext.FileIndex.AddAsync(item2, TestContext.CancellationToken);
		await dbContext.SaveChangesAsync(TestContext.CancellationToken);
	...
	public async Task AddItemAsync_Disposed()
	{
		...
		var itemItShouldContain =
			await dbContext2.FileIndex.FirstOrDefaultAsync(p => p.FilePath == "/test982.jpg", TestContext.CancellationToken);
	...
	public async Task RemoveItemAsync()
	{
		...
		await dbContext.FileIndex.AddAsync(new FileIndexItem("/test44.jpg"), TestContext.CancellationToken);
		await dbContext.SaveChangesAsync(TestContext.CancellationToken);

		var item =
			await dbContext.FileIndex.FirstOrDefaultAsync(p => p.FilePath == "/test44.jpg", TestContext.CancellationToken);
		Assert.IsNotNull(item);
	...
	public async Task RemoveItemAsync_Disposed()
	{
		...
		var dbContext2 = new InjectServiceScope(serviceScope).Context();
		var itemItShouldBeNull =
			await dbContext2.FileIndex.FirstOrDefaultAsync(p => p.FilePath == "/test44.jpg", TestContext.CancellationToken);
		Assert.IsNull(itemItShouldBeNull);
	}
