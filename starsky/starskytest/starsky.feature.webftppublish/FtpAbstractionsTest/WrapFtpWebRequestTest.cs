...
namespace starskytest.starsky.feature.webftppublish.FtpAbstractionsTest
{
	...
	public sealed class WrapFtpWebRequestTest
	{
		...
		{
			_ = new WrapFtpWebRequest(null!) { Method = "t" };
		}
		...
		{
			_ = new WrapFtpWebRequest(null!) { Credentials = new NetworkCredential() };
		}

		[TestMethod]
		public void Credentials_Get_Null()
		{
			// your not allowed to get Credentials
		...
		{
			_ = new WrapFtpWebRequest(null!) { UsePassive = true };
		}
		...
		{
			_ = new WrapFtpWebRequest(null!) { UseBinary = true };
		}
		...
		{
			_ = new WrapFtpWebRequest(null!) { KeepAlive = true };
		}
