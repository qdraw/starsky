...
{
	private static readonly Regex ParseEx = new(@"^(?<major>\d+)" +
	                                            @"(?>\.(?<minor>\d+))?" +
	                                            @"(?>\.(?<patch>\d+))?" +
	                                            @"(?>\-(?<pre>[0-9A-Za-z\-\.]+))?" +
	                                            @"(?>\+(?<build>[0-9A-Za-z\-\.]+))?$",
	...
	///     The <paramref name="obj" /> is not a
	///     <see cref="SemVersion" />.
	/// </exception>
	...
	/// <param name="versionB">The second version to compare.</param>
	/// <returns>
	///     A signed number indicating the relative values of <paramref name="versionA" />
	///     and <paramref name="versionB" />.
	/// </returns>
	...
	/// <returns>
	///     If left is less than or equal to right <see langword="true" />, otherwise
	///     <see langword="false" />.
	/// </returns>
	public static bool operator <=(SemVersion left, SemVersion right)
	{
	...
	/// <param name="right">The right value.</param>
	/// <returns>
	///     If left is greater than or equal to right <see langword="true" />, otherwise
	///     <see langword="false" />.
	/// </returns>
	public static bool operator >=(SemVersion left, SemVersion right)
	{
