...
public static class SonyLensIdConverter
{
	private static Dictionary<string, string> SonyIdDict =>
		new()
		{
			...
			}, // #17(/w correction by Stephen Bishop)/JR
			{
			...
			}, // # (Model G005) (ref https://exiftool.org/forum/index.php/topic,3858.0.html)
			...
			}, // # (no OS for Sony mount, ref JR) (also C013 Model, ref IB)
			...
			}, // #IB (was 'Voigtlander 70-300mm F4.5-5.6"}, // #JD)
			...
			}, // # (Model A15) (added "LD Macro", ref 23)
			...
			}, // #12 (also DG version ref 27, and APO version ref JR)
			...
			}, // #https://exiftool.org/forum/index.php/topic,3472.0.html
			...
			}, // #https://exiftool.org/forum/index.php/topic,3593.0.html
			{
			...
			}, // #11 ("HS-APO" added, white, probably same as 1, non-HS is 25891 - ref JR)
			{ "26291", "Minolta AF 85mm F1.4 New" },
			{
				"26311", "Minolta AF 100-300mm F4.5-5.6 APO"
			}, // #11 (does not exist? https://www.dyxum.com/dforum/lens-data-requested_topic23435_page2.html)
			...
			}, // #Metabones (to this, add Canon LensType)
