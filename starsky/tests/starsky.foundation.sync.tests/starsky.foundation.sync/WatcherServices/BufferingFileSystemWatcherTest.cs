...
namespace starsky.foundation.sync.tests.starsky.foundation.sync.WatcherServices
{
	[TestClass]
	public class BufferingFileSystemWatcherTest
	{
		...
		[ClassCleanup]
		public static void ClassCleanup() // < - The method must be static, public, does not return a value
		{
