...
using starsky.foundation.platform.tests.FakeMocks;
using starsky.foundation.storage.Services;
using starsky.foundation.storage.tests.FakeMocks;
using starsky.foundation.sync.Helpers;
using starskytest.FakeMocks;

namespace starsky.foundation_.starsky.foundation.sync.Helpers
{
	[TestClass]
