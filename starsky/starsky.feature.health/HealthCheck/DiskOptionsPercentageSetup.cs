...
public static class DiskOptionsPercentageSetup
{
	...
	public static void Setup(string fullFilePath, DiskStorageOptions diskOptions,
		float percentage = 0.1f)
	{
		...
		var tenPercentInBytes = Convert.ToInt64(
			new DriveInfo(directoryInfo.Root.FullName).TotalFreeSpace /
