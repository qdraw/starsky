...
[SuppressMessage("Usage",
	"S101: Rename struct 'SHFILEOPSTRUCT' to match pascal case naming rules, consider using 'Shfileopstruct'.")]
...
public static class WindowsShellTrashBindingHelper
{
	...
	private static (bool, string) TrashInternal(string path, ShFileOperations flags =
	...
	internal static string SHQueryRecycleBinInfo(int? hResult, string drivePath,
	...
	/// <summary>
	///     @see:
	///     https://stackoverflow.com/questions/7718028/how-do-i-detect-if-a-drive-has-a-recycle-bin-in-c
