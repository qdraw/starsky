...
public sealed class ImportIndexItem
{
	...
	public DateTime ParseDateTimeFromFileName(ExtensionRolesHelper.ImageFormat imageFormat)
	{
		var structure = SelectStructureSettingsService.GetStructureSetting(Structure, imageFormat);
