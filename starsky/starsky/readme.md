...
15. `useHttpsRedirection` - Redirect users to https page. You should disable this when running an http-only site. Always disabled in debug/develop mode _(default true)_
