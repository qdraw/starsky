...
describe("Preferences", () => {
  ...
  describe("status", () => {
    it("it should mount child components", () => {

      var preferencesUsernameSpy = jest.spyOn(PreferencesUsername, 'default').mockImplementationOnce(() => <></>);
      var preferencesPasswordSpy = jest.spyOn(PreferencesPassword, 'default').mockImplementationOnce(() => <></>);
      var preferencesAppSettingsSpy = jest.spyOn(PreferencesAppSettings, 'default').mockImplementationOnce(() => <></>);
