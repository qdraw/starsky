...
describe("ArrowKeyDown", () => {
  ...
  it("not arrow down or up", () => {
    ...
    ArrowKeyDown({
      key: 't'
    } as any, 0, callback, document.createElement("input"), []);
  ...
  it("1 arrow down", () => {
    ...
    ArrowKeyDown({
      key: 'ArrowDown'
    } as any, -1, callback, inputElement, ["test", "test1"]);
  ...
  it("before of arrow up list", () => {
    ...
    ArrowKeyDown({
      key: 'ArrowUp'
    } as any, 0, callback, inputElement, ["test", "test1"]);
