...
describe("MenuOptionSelectionAll", () => {
  ...
  it("selected-0 keyDown tab skipped", () => {
    ...
    const component = render(
      <MenuSelectCount select={[]} removeSidebarSelection={removeSidebarSelection} />
    );
    ...
    expect(removeSidebarSelection).toHaveBeenCalledTimes(0);
  });
  ...
  it("selected-0 keyDown enter continue", () => {
    ...
    expect(removeSidebarSelection).toHaveBeenCalledTimes(1);
  });
  ...
  it("selected-1 keyDown tab skipped", () => {
    const removeSidebarSelection = jest.fn();
    const component = render(
      <MenuSelectCount select={["1"]} removeSidebarSelection={removeSidebarSelection} />
    );
