...
describe("MenuOptionMoveToTrash", () => {
  it("renders", () => {
    ...
    shallow(<MenuOptionMoveToTrash setSelect={jest.fn()} select={["test.jpg"]} isReadOnly={true}
      state={test} dispatch={jest.fn()} />)
  });
    ...
    it("check if dispatch", async () => {
      ...
      var test = {
        ...newIArchive(), fileIndexItems: [{
          ...newIFileIndexItem(),
          parentDirectory: '/', fileName: 'test.jpg'
        } as IFileIndexItem]
      } as IArchiveProps

      const mockIConnectionDefault: Promise<IConnectionDefault> = Promise.resolve({
        ...newIConnectionDefault(), data: null, statusCode: 200
      });
      ...
      expect(dispatch).toBeCalledWith({ "toRemoveFileList": ["/test.jpg"], "type": "remove" });
    });
  });
});
