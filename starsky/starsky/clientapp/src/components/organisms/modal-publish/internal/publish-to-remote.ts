...
export async function publishToFtp(publishProfileName: string, 
    itemName: string, setIsProcessing: React.Dispatch<React.SetStateAction<ProcessingState>>) {
      ...
      const ftpResult = await FetchPost(
