...
import ArchiveContextWrapper, { ArchiveEventListenerUseEffect } from './archive-wrapper';
...
describe("ArchiveContextWrapper", () => {
  ...
  describe("with mount", () => {
    ...
    it("check if Unauthorized/Login is mounted", () => {
      var args = { ...newIArchive(), fileIndexItems: [], pageType: PageType.Unauthorized } as IArchiveProps;
      var login = jest.spyOn(Login, 'default').mockImplementationOnce(() => { return <></> })
    ...
    it("check if Trash is mounted", () => {
      var args = { ...newIArchive(), fileIndexItems: [], pageType: PageType.Trash } as IArchiveProps;
      var login = jest.spyOn(Trash, 'default').mockImplementationOnce(() => { return <></> })
  ...
  describe("no context", () => {
    it("No context if used", () => {
      ...
      var component = mount(<ArchiveContextWrapper {...args}></ArchiveContextWrapper>);
