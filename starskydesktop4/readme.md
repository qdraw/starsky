...
-   **[starskydesktop](../starskydesktop/readme.md) Desktop Application**
...
npm init electron-app@latest starskydesktop2 -- --template=vite-typescript

npm install -D jest @types/jest
npm install --save electron-settings
npm install --save winston
npm install --save wait-on
npm i --save-dev @types/wait-on
